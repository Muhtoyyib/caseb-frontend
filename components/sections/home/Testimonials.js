...
//         <div className="space-y-3 flex flex-col text-center pb-20 mx-auto sm:space-y-5">
//           {/* Header title */}
//           <p>OUR CLIENTS</p>
...
//                     {testimonial.name}
//                   </p>
//                   <div className="bg-[#4CB5A1] w-[60%] h-[2px]" />
//                 </div>
//               </div>
//             </div>
        ...
        <Slider ref={sliderRef} {...settings}>
          {testimonials.map((testimonial, index) => (
            <div key={index} className="px-2">
              <div className="bg-[#F2FFFF] p-6 md:mr-0 mr-14 md:p-8 h-[250px] max-h-[250px] rounded-lg shadow-lg border border-gray-200 overflow-hidden">
